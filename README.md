...
<span dir="ltr">auth.controller.ts</span>: شامل کنترلر‌های ثبت‌نام، ورود و  اعتبارسنجی.

<span dir="ltr">auth.service.ts</span>: شامل منطق بیزینسی برای مدیریت کاربران و توکن‌ها.
